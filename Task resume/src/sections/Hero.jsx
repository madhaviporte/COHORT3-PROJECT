...
function Hero() {
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden pt-20">
      ...
      <div className="relative w-full section-container py-20 sm:py-24 lg:py-32">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            <div data-hero-badge className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full mb-8 sm:mb-10" style={{ backgroundColor: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
            ...
            <h1 data-hero-heading className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white leading-[1.1] mb-6 sm:mb-8">Hi, I&apos;m<br /><span className="text-lime-400">MADHAVI PORTE</span></h1>
            <p data-hero-role className="text-2xl sm:text-3xl lg:text-4xl text-gray-300 font-light mb-6 sm:mb-8 leading-snug">FULL STACK MERN DEVELOPER</p>
            <p data-hero-intro className="text-base sm:text-lg text-gray-400 mb-10 sm:mb-12 leading-relaxed max-w-xl mx-auto lg:mx-0">I am a Full Stack MERN Developer building scalable, AI-powered web applications. Skilled in both front-end and back-end development, I specialize in React, Node.js, Express, and MongoDB to create seamless user experiences and efficient solutions.</p>
