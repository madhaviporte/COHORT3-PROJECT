        ...
        <div data-contact className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 mb-12 sm:mb-16">
            <a
              ...
              className="inline-flex items-center gap-3 px-10 py-5 bg-lime-400 text-black font-medium rounded-xl hover:bg-lime-300 transition-all duration-200 text-base sm:text-lg"
